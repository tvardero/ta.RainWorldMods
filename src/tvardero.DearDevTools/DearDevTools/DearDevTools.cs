...
using tvardero.DearDevTools.DearDevTools.Menus;

namespace tvardero.DearDevTools.DearDevTools;
...
public class DearDevTools
{
    ...
    private List<object> _inputBlockers = [];
    ...
    public void AddInputBlocker(object blocker) => _inputBlockers.Add(blocker);

    public void RemoveInputBlocker(object blocker) => _inputBlockers.Remove(blocker);
